...
class CastorAnalysis {
  ...
  std::vector<TH1D*> m_hVector_gensumECastorMinus;
  std::vector<TH1D*> m_hVector_gensumECastorPionsMinus;
  std::vector<TH1D*> m_hVector_gensumECastorEPhotonMinus;
  std::vector<TH1D*> m_hVector_gensumECastorOthersMinus;
  ...
  void Run(std::string, std::string, std::string, std::string, int, double, double, int, std::string, std::string, double, double, double, std::string, std::string, std::string);
  void LoadFile(std::string,std::string);
  void CreateHistos();
  void FillHistos(int, double);
  void SaveHistos();
