...
from ForwardAnalysis.TriggerAnalysis.triggerHLTPaths_cfi import *
...
eventSelectionHLT = cms.Sequence(triggerHLTFilter + offlineSelection)
eventSelectionOnlyHLT = cms.Sequence(triggerHLTFilter)
