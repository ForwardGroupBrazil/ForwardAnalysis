...
Example:
    cmsRun DiffractiveWPATTupleMulticrabPFCand.py Run=data_MuonP1 condition=B
...
process.diffractiveWAnalysisTTree = cms.EDAnalyzer("EventInfoPFCandInfoDiffractiveDiffractiveWAnalysisTTree",
        EventInfo = cms.PSet(
...
if config.sys:
   ...
   if config.TriggerOn:
       ...
       process.analysisSequencesShiftedUp + process.analysisSequencesShiftedDown + process.analysisSequences + process.diffractiveWFilter + process.eventSelectionHLT + 
       ...
       print(">> No Trigger.") 
       process.analysis_diffractiveDiffractiveWAnalysisPATTriggerInfoTTree_step = cms.Path(
       process.analysisSequencesShiftedUp + process.analysisSequencesShiftedDown + process.analysisSequences + process.diffractiveWFilter + process.eventSelection +
       process.diffractiveWAnalysisTTreePFShiftedUp + process.diffractiveWAnalysisTTreePFShiftedDown + process.diffractiveWAnalysisTTree)
